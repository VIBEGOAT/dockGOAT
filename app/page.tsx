...
export default function App() {
  ...
  return (
    <ThemeProvider>
      {/* Explicit bg so the off-white shows regardless of z-index stacking */}
      <div className="relative z-10 min-h-screen bg-[#F5F5F7] dark:bg-black text-[#1D1D1F] dark:text-white">
        <ParticleBackground />
        <Header />
        ...
        <section ref={workspaceRef} id="workspace" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-[#86868B] dark:text-[#a1a1a6] max-w-2xl mx-auto">
        ...
        <section className="relative z-10 py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6, ease: [0.4, 0, 0.2, 1] }}
              className="rounded-3xl bg-white dark:bg-[#111111] border border-black/[0.06] dark:border-white/[0.07] p-8 md:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-none"
            >
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-[#1D1D1F] dark:text-white mb-3">Platform Architecture</h3>
                  <p className="text-[#3a3a3c] dark:text-[#a1a1a6] leading-relaxed mb-4">
                    Developed by{' '}
                    <span className="text-blue-600 dark:text-blue-400 font-semibold">Karan Tandon</span>
        ...
        <footer className="relative z-10 border-t border-black/[0.06] dark:border-white/[0.07] py-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <p className="text-sm text-[#86868B] dark:text-[#6e6e73] text-center sm:text-left">
                © 2026 dockGOAT. Built with Next.js, MongoDB &amp; AutoDock Vina.
              </p>
              <p className="text-xs text-[#a1a1a6] dark:text-[#48484a] mt-0.5 text-center sm:text-left">
            ...
            <div className="flex items-center gap-6 text-sm">
              {[
                ...
                <motion.a
                  ...
                  className="text-[#86868B] hover:text-[#1D1D1F] dark:text-[#a1a1a6] dark:hover:text-white transition-colors font-medium"
                >
                  {link.label}
                </motion.a>
              ))}
